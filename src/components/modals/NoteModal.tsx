            ...
            <form
              ...
              <div>
                <input
                  ...
                  className={`w-full px-0 py-2 text-2xl font-bold border-0 border-b-2 focus:ring-0 focus:outline-none bg-transparent transition-colors dark:text-white placeholder:text-gray-300 dark:placeholder:text-gray-600 ${
                    errors.title
              ...
              <div>
                <textarea
                  ...
                  className='w-full px-4 py-3 border border-gray-200 dark:border-slate-700 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-slate-700/50 dark:text-white resize-none transition-all placeholder:text-gray-400 dark:placeholder:text-gray-500'
                />
              ...
              <div className='grid grid-cols-1 sm:grid-cols-3 gap-4'>
                ...
                <div className='bg-gray-50 dark:bg-slate-700/50 rounded-2xl p-4 border border-gray-200 dark:border-slate-600'>
                  ...
                  <select
                    ...
                    className='w-full px-3 py-2 border-0 bg-white dark:bg-slate-800 dark:text-white rounded-xl focus:ring-2 focus:ring-purple-500 text-sm font-medium shadow-sm'>
                ...
                <div className='bg-gray-50 dark:bg-slate-700/50 rounded-2xl p-4 border border-gray-200 dark:border-slate-600'>
                  ...
                  <input
                    ...
                    className='w-full px-3 py-2 border-0 bg-white dark:bg-slate-800 dark:text-white rounded-xl focus:ring-2 focus:ring-amber-500 text-sm font-medium shadow-sm'
                  />
                </div>
              </div>
            </form>
