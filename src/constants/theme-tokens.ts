...
export const darkTokens: ThemeTokens = {
  ...
  background: {
    primary: '#0B1118', // Deep background
    secondary: '#121B26', // Surface background
  },

  // Surfaces - Layered, soft
  surface: {
    primary: '#121B26', // Card background
    secondary: '#0F1822', // Elevated surface
    overlay: 'rgba(2, 10, 18, 0.65)', // Modal backdrop
  },

  // Text - High contrast but reduced fatigue
  text: {
    primary: '#EAF2F6', // Off-white, soft
    secondary: '#9FB0C3', // Supporting text
    muted: '#7C8CA0', // Disabled, placeholder
    inverse: '#0B1118', // On light backgrounds
  },
  ...
  interactive: {
    default: '#3B82F6', // Primary blue
    hover: '#2563EB', // Hover
    active: '#1E4FBF', // Active
    disabled: '#1F2C3B', // Disabled state
  },
  ...
  border: {
    primary: '#1E2C3C', // Subtle borders
    subtle: '#0F1822', // Very subtle dividers
  },
};
